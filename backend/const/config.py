...
# ---
# Centralized configuration management for Mill Dash backend.
# Loads settings from environment variables, provides sensible defaults, and validates critical values.
# ---
...
class Config:
    ...
    Provides properties for API, data, machine, security, MQTT, and background task settings.
    """
    ...
    def API_KEY(self) -> str:
        """
        Returns the FourJaw API key (validated in __init__).
        """
    ...
    def SECURE_HEADER(self) -> Dict[str, str]:
        """
        Returns the secure header for API requests.
        """
    ...
    def _parse_time(cls, time_str: str, default: time) -> time:
        """
        Parse time string in HH:MM format, fallback to default if invalid.
        """
        try:
    ...
    def DAY_SHIFT_START(self) -> time:
        """
        Returns the start time for the day shift.
        """
    ...
    def DAY_SHIFT_END(self) -> time:
        """
        Returns the end time for the day shift.
        """
    ...
    def FOURJAW_STATUS_MAP(self) -> Dict[str, str]:
        """
        Returns mapping of FourJaw statuses to utilization categories.
    ...
    def MACHINE_IDS(self) -> List[str]:
        """
        Returns list of machine IDs from environment or defaults.
        """
    ...
    def MACHINE_ID_MAP(self) -> Dict[str, str]:
        """
        Returns mapping of machine IDs to human-readable names.
        Loads from environment or uses defaults.
        """
    ...
    def ORIGINS(self) -> List[str]:
        """
        Returns list of allowed CORS origins for FastAPI.
        Loads from environment or uses defaults for development.
        """
    ...
    def SECRET_KEY(self) -> str:
        """
        Returns the secret key for JWT signing (validated in __init__).
        """
    ...
    def validate_config(self) -> None:
        """
        Validate critical configuration values and print summary for debugging.
        """
